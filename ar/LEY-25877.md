...
##### Artículo 24. — Queda establecido el siguiente orden

de prelación de normas:

a) Un convenio colectivo posterior puede modificar a

un convenio colectivo anterior de igual ámbito.

b) Un convenio posterior de ámbito distinto, mayor o

menor, modifica al convenio anterior en tanto establezca condiciones

más favorables para el trabajador. A tal fin, la comparación de ambos
